...
const surroundingBubbles = [
    ...
    },
    {
        ...
        description:
            "After graduating high school, I spent the summer in the kitchen at the newly opened Amazon Fresh in Factoria, WA. Was the youngest one and had 4am shifts nearly every day where I prepped, packaged, and labeled various different food products.",
...
export default function Page() {
    const totalBubbles = surroundingBubbles.length;

    return (
        <Layout>
            <div className="relative isolate px-6 pt-14 lg:px-8">
                <div
                    className="absolute inset-0 bg-gradient-to-tr from-[#00ffee] via-[#b9f8ff] to-[#0022ff]"
                    style={{ mixBlendMode: "multiply", opacity: "0.4", zIndex: "-1" }}
                />
                <div className="container inset-0 mx-auto items-center justify-center md:justify-between">
                    <div>
